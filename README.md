...
| DHCP Assignment | ![dhcp](screenshots/dhcp.png) |
| ACL Hit Counts | ![acl](screenshots/acl-hits.png) |
| SSH Session | ![ssh](screenshots/ssh.png) |
| STP Blocking Port | ![stp](screenshots/stp.png) |
